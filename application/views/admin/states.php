<?php if ($this->uri->segment(3) == 'manage'): ?>
	<?= showMsg(); ?>
	<?= getBredcrum(ADMIN, array('#' => 'Add/Update State/Province')); ?>
		...
		<div class="row col-md-12">
			<form action="" name="frmState" role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
				<div class="form-group">
					<div class="col-md-6">
						<label class="control-label" for="name"> State/Province <span class="symbol required">*</span></label>
...
<?php else: ?>
	<?= showMsg(); ?>
	<?= getBredcrum(ADMIN, array('#' => 'Manage States/Provinces')); ?>
	<div class="row margin-bottom-10">
		<div class="col-md-6">
			<h2 class="no-margin"><i class="entypo-list"></i> States/Provinces</h2>
		</div>
		<div class="col-md-6 text-right">
