                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            ...
                            <div class="clearfix"></div>
                            <!-- <div class="col-md-12">
                                <label for="banner_heading" class="control-label"> Main Heading <span class="symbol required">*</span></label>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="col-md-12">
                                <label for="filter_heading" class="control-label"> Fliter Heading <span class="symbol required">*</span></label>
                                <input type="text" name="filter_heading" id="filter_heading" value="<?= $row['filter_heading'] ?>" class="form-control">
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </div>
