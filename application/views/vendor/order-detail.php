                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="txtGrp">
                                                            ...
                                                            <textarea name="customer_notes" id="customer_notes" class="txtBox"><?=$order->order_note?></textarea>
                                                            <button type="button" class="fi-check" id="save-notes" data-o-id="<?=doEncode($order->order_id)?>"></button>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php endif; ?>
                        ...
                        <div class="col col1">
                            <table class="sm pb data_list">
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="4"></td>
                                        <th class="">£<?= order_total_price($order->order_id, 'SERVICES') ?></th>
                                    </tr>
                                    <?php if ($order->pick_and_drop_service == '1') : ?>
                                        <?php if ($order->free_pick_and_drop_service == '0') : ?>
                                            <tr>
                                                <td colspan="4" class="color">Pickup & Delivery Charges</td>
                                                <td class="color">£<?= price_format($order->pick_and_drop_charges) ?></td>
                                            </tr>
                                        <?php else : ?>
                                            <tr>
                                                <td colspan="4" class="color">Pickup & Delivery Charges</td>
                                                <td class="color">Free</td>
                                            </tr>
                                        <?php endif; ?>
                                    <?php endif; ?>
