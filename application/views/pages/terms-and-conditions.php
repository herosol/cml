...
<head>
    <title>Terms & Conditions — Compare My Laundry</title>
...
<body id="home-page">
    ...
    <main common terms>
        ...
        <section id="sBanner">
            ...
            <div class="image"><img src="<?= $base_url ?>images/illustration_terms.svg" alt=""></div>
        </section>
        <!-- sBanner -->
        ...
        <section id="terms">
            <div class="contain">
                <div class="ckEditor">
                    ...
                    <h3>L. RETURNS</h3>
                    <p>Refunds are only issued for the sale amount at current selling market value (see section “O”) of the component(s) inside the computer, and does not include freight charges.</p>
